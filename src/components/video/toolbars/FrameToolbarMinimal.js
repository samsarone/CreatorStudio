...
export default function FrameToolbarMinimal(props) {
  ...
  return (
    <div className={`border-r-2 border-stone-200 ${bgColor} h-full m-auto fixed top-0 
    overflow-y-auto pl-1 r-4 w-[2%] pr-0 `}>
      <div className='mt-[80px]'>
        <FaChevronCircleRight className='text-neutral-100 text-lg cursor-pointer ' onClick={onToggleDisplay}/>
      </div>
    </div>    
  );
}